...
public slipgaji sg = null;
 ...
 tablekaryawan.setModel(tabmode);
     ...
     JOptionPane.showMessageDialog(null, "Error table popup karyawan: "+e);
 }
}
 ...
 sg.id = tablekaryawan.getValueAt(tk, 0).toString();
 sg.nama = tablekaryawan.getValueAt(tk, 1).toString();
 sg.pilih();
 this.dispose();
