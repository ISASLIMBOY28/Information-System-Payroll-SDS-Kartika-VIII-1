...
box.add(jpf);
int button = JOptionPane.showConfirmDialog(null, box, "Password Admin Personalia", JOptionPane.OK_CANCEL_OPTION);

if (button == JOptionPane.OK_OPTION) {
    char[] input = jpf.getPassword();
    String i = String.valueOf(input);
    if(i.equals("adminp7567")) {
        JOptionPane.showMessageDialog(null, "Password Administrasi Personalia Benar!");
        this.dispose();
        new register().setVisible(true);
    }else{
        JOptionPane.showMessageDialog(null, "Password Administrasi Personalia Salah!");
    }
} */
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/gr1.png"))); // NOI18N
        jButton3.setText("Absensi Karyawan");
